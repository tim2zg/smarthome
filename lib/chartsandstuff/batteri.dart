...
class batterieuff extends StatefulWidget {
  @override
...
class sadfwegs extends State<batterieuff> {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Baateri'),
        ),
        body: TabBarView(
          children: [
            FutureBuilder(
                future: betteriday("1d", "1m"),
