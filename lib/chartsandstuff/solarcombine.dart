...
class solarcomdata extends StatefulWidget {
  @override
...
class sadfwegs69 extends State<solarcomdata> {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Solar com'),
        ),
        body: TabBarView(
          children: [
            FutureBuilder(
                future: solarcomdataget("1d", "1m"),
            ...
            FutureBuilder(
                future: solarcomdataget("1mo", "30m"),
                builder: (BuildContext context,AsyncSnapshot snapshot){
                  if(snapshot.connectionState == ConnectionState.done) {
                    return charts.TimeSeriesChart(
                      snapshot.data,
            ...
            FutureBuilder(
                future: solarcomdataget("12mo", "6h"),
                builder: (BuildContext context,AsyncSnapshot snapshot){
                  if(snapshot.connectionState == ConnectionState.done) {
                    return charts.TimeSeriesChart(
                      snapshot.data,
