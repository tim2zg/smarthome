...
class solar1data extends StatefulWidget {
  @override
...
class sadfwegs4 extends State<solar1data> {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Solar 1'),
        ),
        body: TabBarView(
          children: [
            FutureBuilder(
                future: solar1dataget("1d", "1m"),
